...
from .save_image_extended import NODE_CLASS_MAPPINGS as BASE_NODE_CLASS_MAPPINGS, NODE_DISPLAY_NAME_MAPPINGS as BASE_NODE_DISPLAY_NAME_MAPPINGS
from .save_image_extended_civitai import NODE_CLASS_MAPPINGS as CIVITAI_NODE_CLASS_MAPPINGS, NODE_DISPLAY_NAME_MAPPINGS as CIVITAI_NODE_DISPLAY_NAME_MAPPINGS

NODE_CLASS_MAPPINGS = {}
NODE_CLASS_MAPPINGS.update(BASE_NODE_CLASS_MAPPINGS)
NODE_CLASS_MAPPINGS.update(CIVITAI_NODE_CLASS_MAPPINGS)

NODE_DISPLAY_NAME_MAPPINGS = {}
NODE_DISPLAY_NAME_MAPPINGS.update(BASE_NODE_DISPLAY_NAME_MAPPINGS)
NODE_DISPLAY_NAME_MAPPINGS.update(CIVITAI_NODE_DISPLAY_NAME_MAPPINGS)
